                ...
                <form onSubmit={onSubmit} className="mt-4">
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-myred focus:ring-myred"
                      required
                    />
                  </div>
                  <div className="mb-4">
...
export default function ManageClassStaff() {
    ...
    async function fetchData() {
      try {
        ...
        const classResponse = await fetch(
          `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/get-classes`,
          {
            method: "GET",
            credentials: "include",
            headers: { "Content-Type": "application/json" },
        ...
        const freeClassResponse = await fetch(
          `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/get-free-classes?page=${currentPage}&limit=${classesPerPage}`,
          {
            method: "GET",
            credentials: "include",
            headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const endpoint = isLiveModal
        ? `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/create-live-class`
        : `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/create-recorded-class`;
  ...
  const handleFreeSubmit = async (
    ...
    try {
      ...
      const endpoint = `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/create-free-class`;
      const formDataToSend = new FormData();
      Object.entries(sanitizedFormData).forEach(([key, value]) => {
        if (value !== undefined && value !== null) {
          formDataToSend.append(key, value);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/delete-class`,
        {
          method: "POST",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const handleFreeDelete = async (id: string) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/delete-free-class`,
        {
          method: "POST",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
  ...
  const handleStopLive = async (id: string) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/api/staff/stop-live-class`,
        {
          method: "POST",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          ...
          <button
            ...
            className="bg-gray-700 text-white px-4 py-2 rounded-lg flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
            // disabled={loading}
            disabled={true}
          >
