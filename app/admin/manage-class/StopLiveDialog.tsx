...
export default function StopLiveDialog({
  isOpen,
  onClose,
  onStop,
  loading = false,
  title = "Stop Live Class",
  description = "Are you sure you want to stop this live class? This action will end the live session.",
}: StopLiveDialogProps) {
  return (
