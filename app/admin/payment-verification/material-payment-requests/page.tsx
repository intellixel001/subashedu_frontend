...
const MaterialPaymentRequests = () => {
    ...
    const fetchPayments = async () => {
      try {
        ...
        const response = await fetch(
          `${serverUrl}/api/admin/get-material-payment-requests?page=${
  ...
  const verifyPayment = async (materialId: string, paymentId: string) => {
    try {
      const res = await fetch(
        `${serverUrl}/api/admin/verify-material-payment/${materialId}`,
        {
          method: "POST",
          credentials: "include",
  ...
  const deletePayment = async (materialId: string, paymentId: string) => {
    try {
      const res = await fetch(
        `${serverUrl}/api/admin/delete-material-payment/${materialId}`,
        {
          method: "POST",
          credentials: "include",
          body: JSON.stringify({ paymentId }),
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-4">
              <Link href="/admin/payment-verification">
