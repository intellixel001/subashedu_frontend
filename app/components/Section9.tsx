...
const reviews = [
  {
    id: 1,
    name: "আয়েশা রহমান",
    text: "এই HSC রসায়ন ক্র্যাশ কোর্স আমাকে আমার রেজাল্ট ভালো করতে অনেক সাহায্য করেছে।",
  },
  {
    id: 2,
    name: "শফিক ইসলাম",
    text: "অ্যাডমিশন ম্যাথ কোর্সটি বিশ্ববিদ্যালয়ে ভর্তি পরীক্ষার জন্য আমার প্রয়োজনীয় কোর্স ছিল।",
  },
  {
    id: 3,
    name: "মেহেদী হাসান",
    text: "BCS প্রস্তুতি কোর্সটি গোছানো এবং সুসংগঠিত।",
  },
  {
    id: 4,
    name: "রাফিয়া আহমেদ",
    text: "ইংরেজি কোর্সটি আমার ভাষাগত দক্ষতা কার্যকরভাবে উন্নত করেছে।",
  },
];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 uppercase">
            আমাদের শিক্ষার্থীরা তাঁদের অভিজ্ঞতা শেয়ার করেছে।
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {reviews.map((review) => (
            ...
            >
              <div className="absolute -top-4 left-4 text-gray-500 text-xl sm:text-2xl md:text-3xl">
                <FaQuoteLeft />
              </div>
              ...
              <div className="mt-6 flex items-center">
                <div className="h-10 w-10 rounded-full bg-gray-500 text-white flex items-center justify-center font-bold text-sm sm:text-base md:text-lg">
                  {review.name[0]}
                </div>
              ...
              <div className="absolute bottom-4 right-4 text-gray-500 text-xl sm:text-2xl md:text-3xl">
                <FaQuoteRight />
              </div>
            </div>
          ))}
